...
setup(
    ...
    install_requires=["requests", "numpy", "Django==1.9.6", "Eve==0.7.4",
                        ...
                        "ajenti-panel==2.0.66", "apache-libcloud==0.13.2", "oslo.middleware==2.0.0",
                        ...
                        "PyWebDAV==0.9.3", "pyxdg==0.25", "Radicale==1.0.1", "requests==2.4.1", "restkit==2.1.0", "roundup==1.3.0",
                        "salt==0.10.3", "Sanic==0.5.0", "Scrapy==0.24.6", "setuptools==0.6c9", "sleekxmpp==1.3.1", "slixmpp==1.2.3",
                        ...
                        "web2py==1.96.4", "Weblate==2.10", "Werkzeug==0.11"],
    entry_points={
        'console_scripts': [
